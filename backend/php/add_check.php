<?php
   ...
   if($cart_total == 0){
      ...
      $insert_order = $connect->prepare("INSERT INTO `orders`(user_id, nomcl, method, total_products, total_price,payment_status, tipc) VALUES(?,?,?,?,?, 'Aceptado', ?)");
      $insert_order->execute([$user_id, $nomcl, $method,$total_products, $cart_total, $tipc]);
