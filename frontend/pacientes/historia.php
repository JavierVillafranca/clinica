...
<div class="input-block">
    ...
    <li><h3>Historial Médico del Paciente</h3></li>    
    <br>
    ...
    <a type="button" href="imprimir.php?id=<?php echo $d->idpa; ?>" class="button">IMPRIMIR</a>
        ...
        <div class="brise-input">
            ...
            <input type="text" value="<?php echo $d->numhs; ?>" name="text" disabled>
            
            <span class="line"></span>
        </div>
        <div class="brise-input">
            
            <input type="text" value="<?php echo $d->nompa; ?>" name="text" disabled>
        ...
        <div class="brise-input">
            ...
            <input type="text" value="<?php echo $d->apepa; ?>" name="text" disabled>
