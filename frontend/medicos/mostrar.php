...
$sentencia = $connect->prepare("SELECT * FROM doctor INNER JOIN laboratory ON doctor.id_especialidad = laboratory.idlab;");
 $sentencia->execute();
$data =  array();
if($sentencia){
                ...
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a title="Crear Perfil" href="../medicos/crear.php?id=<?php echo $d->idodc ?>" class="fa fa-user-plus"></a>
