                ...
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a title="Actualizar" href="laboratorios_editar.php?id=<?php echo $d->idlab ?>" class="fa fa-pencil tooltip"></a>
                            <a title="Información" href="laboratorios_info.php?id=<?php echo $d->idlab ?>" class="fa fa-info"></a>
