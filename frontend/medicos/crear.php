...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="divider" data-text="Menu">Menú</li>
            <li>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
   ...
   <br>
    ...
    <label for="psw"><b>Nombre y apellido del médico</b></label><span class="badge-warning">*</span>
    <input type="text"  value="<?php echo $d->nodoc . " " . $d->apdoc; ?>"  name="named" readonly required>
    ...
    <label for="psw"><b>Rol</b></label><span class="badge-warning">*</span>
